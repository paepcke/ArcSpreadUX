...
public class ReconCameraGrouper {
	...
	public ReconCameraGrouper (
			...
			PhotoSpreadCell resultSetCell) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
