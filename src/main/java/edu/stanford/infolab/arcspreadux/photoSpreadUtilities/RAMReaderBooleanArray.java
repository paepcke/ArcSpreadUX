 ...
 *         DataInput interface.
 */
public class RAMReaderBooleanArray extends RAMReader {

	boolean[] theInput = null;

	public RAMReaderBooleanArray(boolean[] anInput) {
		theInput = anInput;
	}
	...
	protected byte peek() throws IOException {
		...
		boolean resBool = theInput[arrayPointer];
		if (resBool) return (byte) 1;
		else return (byte) 0;
	}
