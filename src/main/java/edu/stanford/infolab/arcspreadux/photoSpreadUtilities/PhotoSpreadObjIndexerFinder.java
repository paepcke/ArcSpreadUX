...
import edu.stanford.infolab.arcspreadux.photoSpreadObjects.ObjectIndexerFinder;
import edu.stanford.infolab.arcspreadux.photoSpreadObjects.PhotoSpreadDoubleObject;
import edu.stanford.infolab.arcspreadux.photoSpreadObjects.PhotoSpreadFileObject;
...
public class PhotoSpreadObjIndexerFinder implements ObjectIndexerFinder<PhotoSpreadObject> {
	...
	public class DispatchHashMap extends HashMap<Class<?> , PhotoSpreadDispatch> { 
		...
		public DispatchHashMap () {
			...
			try {
				put(Class.forName("edu.stanford.infolab.arcspreadux.photoSpreadObjects.PhotoSpreadStringObject"), PhotoSpreadDispatch.STRING);
				put(Class.forName("edu.stanford.infolab.arcspreadux.photoSpreadObjects.PhotoSpreadDoubleObject"), PhotoSpreadDispatch.DOUBLE);
				put(Class.forName("edu.stanford.infolab.arcspreadux.photoSpreadObjects.PhotoSpreadTextFile"), PhotoSpreadDispatch.FILE);
				put(Class.forName("edu.stanford.infolab.arcspreadux.photoSpreadObjects.PhotoSpreadImage"), PhotoSpreadDispatch.FILE);
				put(Class.forName("edu.stanford.infolab.arcspreadux.photoSpreadObjects.PhotoSpreadTableObject"), PhotoSpreadDispatch.TABLE);
