...
import edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException;
import edu.stanford.infolab.arcspreadux.photoSpreadObjects.PhotoSpreadTableObject;
import edu.stanford.infolab.arcspreadux.photoSpreadObjects.photoSpreadComponents.KeyBindEditor;
...
public class PhotoSpreadTableMenu extends JMenuBar{
	...
	private void assembleFileMenu (JMenu fileMenu) {
		...
		addMenuItem(fileMenu, "Open Sheet", 'O', new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				PhotoSpreadTableMenu.getTableObject().clear();  	   
				InputOutput.loadTable(PhotoSpreadTableMenu.this, PhotoSpreadTableMenu.getTableModel());
			}
		});

		addMenuItem(fileMenu, "Save Sheet As", 'S', new ActionListener(){
			public void actionPerformed(ActionEvent event) {
				InputOutput.saveTable(PhotoSpreadTableMenu.this, PhotoSpreadTableMenu.getTableModel());
			}
		});
