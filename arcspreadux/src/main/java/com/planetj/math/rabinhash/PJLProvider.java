...
/**
 * <p>This class represents the provider "PJL", which provides two {@link java.security.MessageDigest} algorithm
 ...
 * java.security APIs.</p>
 *
 * <p>See <a href="http://java.sun.com/j2se/1.4.2/docs/api/index.html">here</a> for details on how to
 * use MessageDigest objects.</p>
 *
 * <p>Note: in order to use the {@link java.security.MessageDigest} algorithms provided by this package, you must add
...
public final class PJLProvider extends Provider {
    ...
    /**
     * <p>Configures the provider "PJL" to provide {@link java.security.MessageDigest} algorithms
     * "RHF32" and "RHF64".</p>
     */
    public PJLProvider() {
        super("PJL", 1.0, "PJL Provider 1.0, providing digests based on Rabin hash functions");
