...
import edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.KeyBindingsFileSyntaxError;
import edu.stanford.infolab.arcspreadux.photoSpreadLoaders.XMLFileFilter;
import edu.stanford.infolab.arcspreadux.photoSpreadTable.PhotoSpreadCell;
import edu.stanford.infolab.arcspreadux.photoSpreadTable.PhotoSpreadDragDropManager;
...
import edu.stanford.infolab.arcspreadux.photoSpreadUtilities.CellCoordinates;
import edu.stanford.infolab.arcspreadux.photoSpreadUtilities.ChangeManager;
...
import edu.stanford.infolab.arcspreadux.photoSpreadUtilities.Misc;
import edu.stanford.infolab.arcspreadux.photoSpreadUtilities.Misc.ShowHelpAction;
import edu.stanford.infolab.arcspreadux.photoSpreadUtilities.Misc.WindowCloseAction;
import edu.stanford.infolab.arcspreadux.photoSpreadUtilities.PhotoSpreadContextMenu;
...
public class KeyBindEditor extends JFrame {
	...
	/****************************************************
	 * Constructor(s)
	 * @throws edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException 
	 *****************************************************/

	public KeyBindEditor(PhotoSpreadTable photoSpreadTable) throws edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
	...
	public KeyBindEditor(PhotoSpreadTable photoSpreadTable, File xmlBindingsFile) throws IOException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException { 
	...
	private class KeyStrokeSpec implements Externalizable {
		...
		public KeyStrokeSpec (String spec) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
	...
	private class CellSpec implements Externalizable {
		...
		public CellSpec (String spec) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
	...
	private class DnDKeyBindSpec {
		...
		public DnDKeyBindSpec (String keySpec, String cellSpec) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
		...
		public void setBindingSpec (String keySpec, String cellSpec) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
		...
		public void setKeySpec (String keySpec) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
			set (new KeyStrokeSpec(keySpec));
		}

		public void setCellSpec (String cellSpec) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
	...
	throws IOException, KeyBindingsFileSyntaxError, IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
	...
	private void initEditor() throws edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
	...
	private ArrayList<DnDKeyBindSpec> getExistingBindings () throws edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
	...
	class DataTableModel extends AbstractTableModel {
		...
		private DnDKeyBindSpec makeEmptyRow() {
			...
			try {
				...
				// 
			} catch (edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException e) {
	...
	public static void main (String[] args) throws HeadlessException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
