...
extends TreeSet<E> implements Iterable<E> {
	...
	public RandomSubsetIterator iterator (int startPosIncl) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
		return new RandomSubsetIterator(startPosIncl, this);
	}

	public RandomSubsetIterator iterator (int startPosIncl, int endPosExcl) throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
...
*/
	...
	class RandomSubsetIterator implements Iterator<E> {
		...
		throws IllegalArgumentException, edu.stanford.infolab.arcspreadux.photoSpread.PhotoSpreadException.IllegalArgumentException {
