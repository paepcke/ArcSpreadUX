...
import edu.stanford.infolab.arcspreadux.photoSpreadObjects.photoSpreadComponents.WorkspaceObjectsPanel;
...
import edu.stanford.infolab.arcspreadux.photoSpreadUtilities.OsmoticOverlayTracker;
			...
			try {
				...
				if (trans.isDataFlavorSupported(DataFlavor.javaFileListFlavor)) {
					...
					if (Class.forName("java.util.List").isInstance(rawTransData)) {
						fileList = (java.util.List<File>) rawTransData; 
					}
